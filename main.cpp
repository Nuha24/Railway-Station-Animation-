...
void station()
{
    ...
    renderBitmapString(-0.16f, 0.505f, 0.0f, GLUT_BITMAP_HELVETICA_18, "            Railway Station        ");
}
...
// Function to render bitmap string
...
// Function to calculate the width of a bitmap string
float getBitmapStringWidth(void *font, const char *string) {
    float width = 0.0f;
    const char *c;
    for (c = string; *c != '\0'; c++) {
...
// Function to render centered bitmap string
void renderCenteredBitmapString(float y, float z, void *font, const char *string) {
    float width = getBitmapStringWidth(font, string);
    float x = -width / (2.0f * glutGet(GLUT_WINDOW_WIDTH) / 2.0f);
    renderBitmapString(x, y, z, font, string);
}

void information(void) {
    glClear(GL_COLOR_BUFFER_BIT);
    glClearColor(204 / 255.0f, 213 / 255.0f, 192 / 255.0f, 1.0f); // Background color: #CCD5C0

    glColor3f(56 / 255.0f, 66 / 255.0f, 43 / 255.0f); // Text color: #38422B
    renderCenteredBitmapString(0.91f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "A Railway Station with Season Change");
    renderCenteredBitmapString(0.86f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "Computer Graphics");
    renderCenteredBitmapString(0.82f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "Introduction");

    glLineWidth(4);
    glBegin(GL_LINES);
    glColor3f(110 / 255.0f, 119 / 255.0f, 83 / 255.0f); // Line color: #6E7753
    glVertex2f(-0.88, 0.8);
    glVertex2f(0.88, 0.8);
    glEnd();

    glColor3f(110 / 255.0f, 119 / 255.0f, 83 / 255.0f); // Text color: #6E7753
    renderCenteredBitmapString(0.7f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "Maksura Nuha");
    renderCenteredBitmapString(0.65f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "C211224");
    renderCenteredBitmapString(0.60f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "7th Semester(AF)");
    ...
    glColor3f(56 / 255.0f, 66 / 255.0f, 43 / 255.0f); // Text color: #38422B
    renderCenteredBitmapString(0.4f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "Supervised by");
    renderCenteredBitmapString(0.35f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "Umme Habiba Bushra");
    renderCenteredBitmapString(0.30f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "Adjunct Lecturer");
    renderCenteredBitmapString(0.25f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "Department of Computer Science And Engineering");
    renderCenteredBitmapString(0.15f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "International Islamic University Chittagong");
...
int main(int argc, char** argv) {
    ...
    glutTimerFunc(35000,rainUp, 0);/// rainy
